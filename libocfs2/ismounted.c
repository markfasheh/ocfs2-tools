...
/*
 * ocfs2_check_if_mounted() sets the mount_flags OCFS2_MF_MOUNTED,
 * OCFS2_MF_READONLY, and OCFS2_MF_ROOT
 * 
 */
...
int main(int argc, char **argv)
{
	...
	mntpt[0] = 0;
	retval = ocfs2_check_mount_point(argv[1], &mount_flags,
					  mntpt, sizeof(mntpt));
	if (retval) {
		com_err(argv[0], retval,
			"while calling ocfs2_check_if_mounted");
		exit(1);
	}
