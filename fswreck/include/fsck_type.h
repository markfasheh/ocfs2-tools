 ...
 *			EXTENT_BLKNO_RANGE
 *
 * Chain allocator error: CHAIN_COUNT, CHAIN_NEXT_FREE, CHAIN_EMPTY,
 *			  CHAIN_I_CLUSTERS, CHAIN_I_SIZE, CHAIN_GROUP_BITS,
 *			  CHAIN_HEAD_LINK_RANGE, CHAIN_LINK_GEN, 
 *			  CHAIN_LINK_MAGIC, CHAIN_LINK_RANGE,CHAIN_BITS
 *
 * Inode error: INODE_ALLOC_REPAIR, INODE_SUBALLOC, INODE_GEN, INODE_GEN_FIX,
 *		INODE_BLKNO,INODE_NZ_DTIME, INODE_SIZE, INODE_CLUSTERS,
 *		INODE_NOT_CONNECTED, INODE_COUNT, INODE_ORPHANED
 *
 * group descriptor error: GROUP_UNEXPECTED_DESC, GROUP_EXPECTED_DESC,
 *			   GROUP_GEN, GROUP_PARENT, GROUP_BLKNO, GROUP_CHAIN,
 *			   GROUP_FREE_BITS
 *
 ...
 *
 * Directory error: 	DIR_ZERO, DIRENT_DOTTY_DUP, DIRENT_NOT_DOTTY, 
 *			DIRENT_DOT_INODE, DIRENT_DOT_EXCESS, DIRENT_ZERO,
 *			DIRENT_NAME_CHARS, DIRENT_INODE_RANGE, 
 *			DIRENT_INODE_FREE, DIRENT_TYPE, DIR_PARENT_DUP,
 *			DIRENT_DUPLICATE, DIRENT_LENGTH, DIR_NOT_CONNECTED
 */
#endif
